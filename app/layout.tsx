...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang={siteMetadata.language} className={`${FONT_OUTFIT.variable} scroll-smooth`} suppressHydrationWarning>
      ...
      <link rel="icon" type="image/png" sizes="32x32" href={`${basePath}/static/favicons/tennis-racquet.png`} />
      <link rel="icon" type="image/png" sizes="16x16" href={`${basePath}/static/favicons/tennis-racquet.png`} />
